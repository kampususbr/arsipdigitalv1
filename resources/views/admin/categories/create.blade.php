...
@section('content')
<div class="mb-4">
    <h1 class="page-title mb-1">Tambah Kategori Baru</h1>
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-plus"></i> Form Kategori Baru</h5>
            </div>
            <form method="POST" action="{{ route('admin.categories.store') }}" class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Contoh: Laporan Keuangan" value="{{ old('name') }}" required>
                    @error('name')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon" placeholder="Contoh: fa-folder" value="{{ old('icon', 'fa-folder') }}">
